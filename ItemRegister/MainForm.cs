...
namespace DBRegister
{
    public partial class MainForm : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            lKidsDate.Text += "出力ユーザバーコード例: " + Barcode.PREFIX + Barcode.USER + stPrompt1.Substring(2) + "0001" + Environment.NewLine;
            lKidsDate.Text += "出力商品バーコード例　: " + Barcode.PREFIX + Barcode.ITEM + "010001";
        }
        ...
        {
            return row[0].Length == Barcode.DATA_LENGTH && !row[1].Equals("");
        }
